/*
 * Internal header for the AppTrackeriOS extension.
 *
...
#ifndef APPTRACKERIOS_INTERNAL_H
#define APPTRACKERIOS_INTERNAL_H
...
s3eResult AppTrackeriOS_loadModuleToCache_platform(const char* location_code);
...
#endif /* !APPTRACKERIOS_INTERNAL_H */